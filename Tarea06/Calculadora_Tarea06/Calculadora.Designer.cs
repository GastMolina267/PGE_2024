...
namespace Calculadora_Tarea06
{
    partial class Calculadora
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnSuma
            // 
            btnSuma.BackColor = Color.FromArgb(255, 128, 128);
            btnSuma.Font = new Font("Verdana", 15.75F);
            btnSuma.Location = new Point(14, 72);
            ...
            btnMenos.Font = new Font("Verdana", 15.75F);
            btnMenos.Location = new Point(65, 72);
            ...
            // btnMulti
            // 
            btnMulti.BackColor = Color.FromArgb(255, 128, 128);
            btnMulti.Font = new Font("Verdana", 15.75F);
            btnMulti.Location = new Point(116, 72);
            btnMulti.Name = "btnMulti";
            btnMulti.Size = new Size(45, 45);
            btnMulti.TabIndex = 8;
            btnMulti.Text = "*";
            btnMulti.UseVisualStyleBackColor = false;
            btnMulti.Click += button12_Click;
            // 
            // btnBorrar
            // 
            ...
            btnDiv.Font = new Font("Verdana", 15.75F);
            btnDiv.Location = new Point(167, 72);
            btnDiv.Name = "btnDiv";
